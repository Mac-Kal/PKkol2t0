...
double Budynek::obliczPodatek() const {
    // Implementuj swoją logikę obliczania podatku tutaj
    // (jeśli nie jest już zaimplementowana w klasach pochodnych)
    return 10.0 * metraz; // Podatek dla zwykłego budynku
}
...
double Posiadlosc::obliczPodatek() const {
    // Implementuj swoją specyficzną logikę obliczania podatku dla Posiadlosci
    // (używając obliczPodatek() z klasy bazowej, jeśli to konieczne)
